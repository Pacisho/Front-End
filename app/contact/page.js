...
export default function Contact() {
  ...
  // ข้อมูลการติดต่อ
  const contactInfo = {
    email: "phatdanaikaeochan@gmail.com",
    phone: "061-XXX-XXXX",
    ...
    faq: [
      { 
        question: "ข้อมูลของนักแข่งมีกี่ทีม?", 
        answer: "ข้อมูลของนักแข่งมีทั้งหมด 10-20 ทีม ขึ้นอยู่กับการแข่งขันในแต่ละปี" 
      },
      { 
        question: "ข้อมูลของนักแสดงเด็กมีกี่คน?", 
        answer: "ข้อมูลเด็กมีประมาณ 50 คน ซึ่งเป็นนักแสดงที่มีความสามารถและได้รับการคัดเลือกมาอย่างดี" 
      },
      { 
        question: "สามารถให้สืบหาข้อมูลของนักแข่งที่ไม่มีในเว็บไซต์ให้ได้ไหม?", 
        answer: "ได้ครับ หากคุณต้องการข้อมูลเพิ่มเติมเกี่ยวกับนักแข่งหรือนักเเสดงที่ไม่มีในเว็บไซต์ สามารถติดต่อเราผ่านแบบฟอร์มด้านล่างได้เลย" 
      }
    ]
  };
  ...
  return (
    <div className="container my-5">
      ...
      <div className="text-center mb-5">
        <h1 className="display-4 fw-bold mb-3" style={{ color: '#2d2d2dff' }}>ติดต่อเรา</h1>
        <p className="lead mb-4">มีคำถามหรือข้อสงสัย? ติดต่อเราได้ตามเวลาที่แจ้งให้ทราบ เรายินดีให้คำปรึกษาและช่วยเหลือคุณ</p>
          ...
          <ul className="nav nav-pills nav-fill">
            <li className="nav-item">
              <button 
                ...
                style={{ 
                  background: activeMethod === 'form' ? '#ff003cff' : 'transparent',
            ...
            <li className="nav-item">
              <button 
                ...
                style={{ 
                  background: activeMethod === 'info' ? '#009bb3ff' : 'transparent',
            ...
            <li className="nav-item">
              <button 
                ...
                style={{ 
                  background: activeMethod === 'faq' ? '#5900ffff' : 'transparent',
        ...
        <div className="col-12">
          <div className="p-4 rounded-4 shadow-sm" style={{ 
            ...
            {activeMethod === 'form' && (
              <div className="row">
                <div className="col-lg-6 mb-4 mb-lg-0">
                  <div className="p-4">
                    <h3 className="mb-4" style={{ color: '#ff003cff' }}>
            ...
            {activeMethod === 'info' && (
              <div className="row">
                <div className="col-lg-6 mb-4 mb-lg-0">
                  <h3 className="mb-4" style={{ color: '#00b7d3ff' }}>
            ...
            {activeMethod === 'faq' && (
              <div>
                <h3 className="mb-4" style={{ color: '#5900ffff' }}>
                  <i className="bi bi-question-circle-fill me-2"></i>
                  คำถามที่พบบ่อย
                </h3>
                    ...
                    <div key={index} className="accordion-item border-0 mb-3 shadow-sm rounded-3 overflow-hidden">
                      <h2 className="accordion-header" id={`heading${index}`}>
                        <button 
                          ...
                          style={{ 
                            background: 'rgba(166, 125, 244, 0.1)',
                            color: '#333',
                            fontWeight: '600',
                            padding: '15px 20px'
                          }}
      ...
      <div className="row mt-5">
        <div className="col-12">
          <div className="p-4 rounded-4 shadow-sm text-center" style={{ background: 'rgba(174, 160, 241, 0.21)' }}>
            <h3 className="mb-3" style={{ color: '#5500f4ff' }}>ลงทะเบียนเพื่อรับข่าวสารจากเราก่อนใคร</h3>
            <p className="mb-4">รับข่าวสารจากเราเว็บไซต์ของเราก่อนใครเพื่อน</p>
